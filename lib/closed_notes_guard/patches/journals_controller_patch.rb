...
unless JournalsController.included_modules.include?(ClosedNotesGuard::Patches::JournalsControllerPatch)
  JournalsController.include ClosedNotesGuard::Patches::JournalsControllerPatch
end
